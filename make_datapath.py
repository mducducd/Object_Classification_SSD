...
def make_datapath_list(root_path):
    ...
    train_id_name = osp.join(root_path, "ImageSets/Main/train.txt")
    val_id_name = osp.join(root_path, "ImageSets/Main/val.txt")
    ...
    for line in open(train_id_name):
        file_id = line.strip() # delete space \n
